...
from youtube_common import (
    WIKI_ROOT, COLLECTION_DIR, CATALOG_PATH, TRANSCRIPT_DIR, MANIFEST_PATH,
    STAGING_PATH, ARCHIVE_PATH, CHANNEL_URL, CHANNEL_ID, CHANNEL_NAME,
...
# ── paths & constants ─────────────────────────────────────────────────────────
# CHANNEL_URL, CHANNEL_ID, CHANNEL_NAME, and all collection/archive paths are
# imported from youtube_common (shared with fetch_youtube_api.py).
